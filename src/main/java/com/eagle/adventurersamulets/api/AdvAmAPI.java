...
public final class AdvAmAPI {
  ...
  /**
   * Registers a simple Crafting Rune recipe.
   * This assumes the output quantity is 8, and the tier required is 0.
   *
   ...
   * This assumes the tier required is 0.
   *
   * @param input          An oredict key, or Block instance used in the creation of the recipe
   * @param output         The block state created in the process
   ...
   * @return The recipe created
   */
  public static RecipeCraftingRune registerCraftingRuneRecipeWithQuantity(IBlockState output, int outputQuantity, Object... input) {
   ...
   * @return The recipe created
   */
  public static RecipeCraftingRune registerFullCraftingRuneRecipe(IBlockState output, int outputQuantity, int tierRequired, Object... input) {
