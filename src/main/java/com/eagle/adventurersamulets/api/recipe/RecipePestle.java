...
public class RecipePestle {
  ...
  public RecipePestle(ItemStack output, Object input) {
    if (input instanceof ItemStack) {
      ...
      throw new RuntimeException("Invalid Pestle recipe : " + output + ", " + input);
    }
  ...
  public boolean matches(ItemStack itemStack, RecipePestle recipe) {
    if (recipe.getInput() instanceof ItemStack) {
      return itemStack.copy().getItem() == ((ItemStack) recipe.getInput()).copy().getItem()
          && itemStack.copy().getItemDamage() == ((ItemStack) recipe.getInput()).copy()
          .getItemDamage();
